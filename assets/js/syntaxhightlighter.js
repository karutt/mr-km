...
;(function()
{
	...
	function Brush()
	{
		...
		'protected public return short static strictfp super switch synchronized  throw ' +
		'throws transient try void volatile while true';
		var functionsBold =	'setup draw';
		var functions =	'size strokeWeight stroke background pushMatrix popMatrix pop push createCanvas  createVector Vector translate ' +
		'createBotton createSlider' +
		...
		'brightness rectMode mouseDragged mouseReleased millis map hour minute second link length beginShape prototype';
		...
		'key pixels CENTER_RADIUS mousePressed CORNER pmouseX pmouseY CLOSE TRIANGLES  setup draw';

		var custom1 = 'var function ';
		var custom2 = 'this';
		...
		this.regexList = [
			...
			{ regex: new RegExp(this.getKeywords(custom1), 'gmi'),	css: 'color1' },
			{ regex: new RegExp(this.getKeywords(custom2), 'gmi'),	css: 'color2' }
		];
